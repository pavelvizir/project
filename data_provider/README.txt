Переделал parser. Исправил ошибки, убрал ненужное, временно объединил в один скрипт raw_data_provider и parser,
запустив raw_data_provider в отдельном потоке.
